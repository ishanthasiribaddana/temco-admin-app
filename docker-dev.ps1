# =============================================================================
# Docker Development Helper Script (PowerShell)
# =============================================================================
# Usage:
...
switch ($Command) {
    "up" {
        Write-Host "Starting local Docker environment..." -ForegroundColor Green
        docker-compose -f $BASE -f $LOCAL --env-file $ENV_FILE up -d
    }
    "down" {
        Write-Host "Stopping local Docker environment..." -ForegroundColor Yellow
