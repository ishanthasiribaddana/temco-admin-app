...
// Temco Bank Logo Component (same as finance.temcobank.com)
const TemcoLogo = () => (
...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // SSO Login via AdminApp Backend API
        ...
        login(
          {
            ...
            role: response.user.roleName || 'ADMIN',
            permissions: ['*'],
          },
          response.token
        )
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-temco-blue/10 via-temco-pink/5 to-temco-yellow/10 p-4">
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md border-t-4 border-temco-blue">
        <div className="text-center mb-6">
          <TemcoLogo />
          <h2 className="text-xl font-semibold text-secondary-800 mt-4">Admin Portal</h2>
